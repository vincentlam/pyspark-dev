...
ARG SPARK_BUILD=spark-2.4.8-bin-hadoop2.7
...
RUN pip3 install --no-cache-dir --upgrade pip setuptools wheel black jupyter pandas pyspark==2.4.8 delta-spark pytest-cov pre-commit pytz

COPY jars/delta-core_2.11-0.6.1.jar /home/jars/delta-core_2.11-0.6.1.jar
