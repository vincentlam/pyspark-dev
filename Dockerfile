...
ARG SPARK_BUILD=spark-3.0.3-bin-hadoop3.2
...
RUN pip3 install --no-cache-dir --upgrade pip setuptools wheel black jupyter pandas pyspark==3.0.3 delta-spark pytest-cov pre-commit pytz

COPY jars/delta-core_2.12-1.0.0.jar /home/jars/delta-core_2.12-1.0.0.jar
